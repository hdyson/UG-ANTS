...
**UG-Contrib rose stem logs** <br>
[please enter the workflow name here as it has been run e.g. ug-ants-contrib/run1] <br>
...
- [ ] This will maintain results for UG-ANTS `rose stem --group=all` tests
- [ ] This will this maintain results for UG-Contrib `rose stem --group=all` tests
